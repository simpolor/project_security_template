...
-- 비밀번호는 media!@34
INSERT INTO member(member_id, member_pw, member_name, member_email, member_roles, regi_date, del_yn)
     VALUES ('abc', '$2a$10$oagao9FGvso6Jy4bHgzf4.rWSINknboRhC/wRYyOiK3cjcQkEdO/S', '사용자', 'abc@simpolor.com', 'USER', now(), 'N');
INSERT INTO member(member_id, member_pw, member_name, member_email, member_roles, regi_date, del_yn)
     VALUES ('admin', '$2a$10$oagao9FGvso6Jy4bHgzf4.rWSINknboRhC/wRYyOiK3cjcQkEdO/S', '관리자', 'admin@simpolor.com', 'ADMIN',now(), 'N');
